...
<p>
  Class website:
  <a href="https://www.moodyrahman.com/135">
    https://www.moodyrahman.com/135
  </a>
</p>
...
<p>
  ...
  Software development is a skill that involves solving real-world problems by
  developing computer programs. Breaking a problem down, then creating a series
  of logical steps (an algorithm) that solves the problem is the conceptual part
  of the course. The technical component involves translating the solution into
  a working computer program. A successful student will be able to clearly and
  logically develop an algorithmic solution to a problem, while being
  comfortable enough with C++ to transform the algorithm into a working computer
  program.
</p>
...
<p>
  The use of artificial intelligence (AI) is strictly prohibited in all
  coursework and assignments. This includes, but is not limited to, the use of
  AI-generated text, speech, or images, as well as the use of AI tools or
  software to complete any portion of a project or assignment. Any violations of
  this policy will result in disciplinary action, up to and including a failing
  grade for the assignment or course. Our goal is to encourage critical thinking
  and creativity, and the use of AI detracts from this objective. Students are
  expected to use their own knowledge, research and analysis to complete
  coursework.
</p>
...
<p>
  ...
  AI, but they are equivalent to learning your ABC's and your multiplication
  tables. To use AI in your assignments at this stage, will do nothing but leave
  you underprepared for coursework and projects where AI cannot help (which will
  happen much sooner than later!). I implore you to put in the requisite sweat
  and effort for this class, for the sake of your own growth as engineers and
  computer scientists.
</p>
...
<p>
  ...
  consult the Office of AccessABILITY located in Room El124 to secure necessary
...
<p>
  ...
  (including CUNY-sponsored trips and events) are entitled to the rights
  outlined in the Bill of Rights for Hunter College. a. Sexual Violence:
  Students are strongly encouraged to immediately report the incident by calling
  911, contacting NYPD Special Victims Division Hotline (646-610-7272) or their
  local police precinct, or contacting the College's Public Safety Office
  (212-772-4444). b. All Other Forms of Sexual Misconduct: Students are also
  encouraged to contact the College' s Title IX Campus Coordinator, Dean John
  ...
  services through the Counseling and Wellness Services Office, Hunter East
  1123. CUNY Policy on Sexual Misconduct Link:
  <a
    href="http://www.cuny.edu/about/administration/offices/la/Policy-on-SexualMisconduct-12-1-14-with-links.pdf"
  >
